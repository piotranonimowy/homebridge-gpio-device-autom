...
DigitalOutput.prototype = {
	setState: function (value, callback) {
		...
		if (this.duration && value && this.durationTimeoutID == null) {
		...
		} else if (this.duration && !value && this.durationTimeoutID != null) {
			/* Valve turned off manually before the timer elapsed: cancel it and reset the
			   remaining duration so the next activation starts from the full predefined value. */
			this.durationTimeoutID.pause();
			this.durationTimeoutID = null;
